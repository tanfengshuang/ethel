...
ColVis.prototype = {
	...
	"_fnConstruct": function ( init )
	{
		...
		this.dom.button = $( '<button />', {
				'class': "ColVis_Button ColVis_MasterButton btn btn-default dropdown-toggle",
                'type': "button",
	...
	"_fnDrawCallback": function ()
	{
		...
		for ( var i=0, ien=buttons.length ; i<ien ; i++ ) {
			...
			if ( button.__columnIdx !== undefined ) {
                ...
                $(button).toggleClass('selected', columns[ button.__columnIdx ].bVisible);
			}
		}
	...
	"_fnAddButtons": function ()
	{
        ...
        extras.push('<li class="divider"></li>')
		this.dom.buttons = extras.concat(this.dom.buttons);
	...
	{
		return $('<ul />', {
				'class': "show-tick dropdown-menu pull-right"
			} )[0];
	},
